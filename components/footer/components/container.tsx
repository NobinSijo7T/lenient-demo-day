...
const Container: NextPage<ContainerType> = ({ className = "" }) => {
  ...
  return (
    <header className={[styles.container, className].join(" ")}>
      <h1 className={styles.becomeAPartner}>Become a partner?</h1>
      <div className={styles.becomeAPart}>
        Become a part of Lenient Tree and get exclusive access to all events
        organized by Lenient Tree.
      </div>
      <button className={styles.contactUsParent}>
        ...
        {socialLinks.map((social) => (
          ...
          >
            <div 
              ...
              style={{ 
                background: social.backgroundColor
              }}
            >
              {social.icon}
            </div>
